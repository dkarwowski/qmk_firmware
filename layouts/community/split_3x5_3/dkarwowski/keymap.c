...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [NUM] = LAYOUT_split_3x5_3(
    KC_GRV,  KC_7,    KC_8,    KC_9,    KC_LBRC, U_NA,    U_NA,    U_NA,    U_NA,    RESET,
    KC_SCLN, KC_4,    KC_5,    KC_6,    KC_RBRC, U_NA,    KC_LSFT, KC_LCTL, KC_LALT, KC_LGUI,
    KC_EQL,  KC_1,    KC_2,    KC_3,    KC_BSLS, U_NA,    U_NA,    U_NA,    KC_ALGR, U_NA,
                      KC_0,  KC_DOT,    KC_MINS, U_NA,    U_NA,    U_NA
  ),
  [SYM] = LAYOUT_split_3x5_3(
    KC_TILD, KC_AMPR, KC_ASTR, KC_LPRN, KC_LCBR, U_NA,    U_NA,    U_NA,    U_NA,    RESET,
    KC_COLN, KC_DLR,  KC_PERC, KC_CIRC, KC_RCBR, U_NA,    KC_LSFT, KC_LCTL, KC_LALT, KC_LGUI,
    KC_PLUS, KC_EXLM, KC_AT,   KC_HASH, KC_PIPE, U_NA,    U_NA,    U_NA,    KC_ALGR, U_NA,
