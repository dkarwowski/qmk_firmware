...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [NUM] = LAYOUT_split_3x5_3(
    ...
    KC_DOT,  KC_4,    KC_5,    KC_6,    KC_PLUS, U_NA,    KC_LSFT, KC_LCTL, KC_LALT, KC_LGUI,
    KC_0,    KC_1,    KC_2,    KC_3,    KC_ASTR, U_NA,    U_NA,    U_NA,    KC_ALGR, U_NA,
                      KC_DLR,  KC_MINS, KC_EQL,  U_NA,    U_NA,    U_NA
  ),
  [SYM] = LAYOUT_split_3x5_3(
    ...
    KC_EXLM, KC_AT,   KC_LBRC, KC_RBRC, KC_SCLN, U_NA,    U_NA,    U_NA,    KC_ALGR, U_NA,
                      KC_PIPE, KC_COLN, KC_UNDS, U_NA,    U_NA,    U_NA
  ),
